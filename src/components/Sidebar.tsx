...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const menuItems: {
    ...
    },
    {
      id: 'convert-text',
      number: isKm ? '៣' : '3',
      label: isKm ? 'បម្លែងជា Word & Excel' : 'Word & Excel (.xlsx)',
      sublabel: isKm ? 'AI OCR រក្សាជើងអក្សរ & តារាង' : 'Preserve fonts, tables & export',
      icon: FileCheck2,
    ...
    },
    {
      id: 'image-to-word',
      number: isKm ? '៤' : '4',
      label: isKm ? 'រូបភាពទៅជា Word & Excel' : 'Image to Word & Excel',
      sublabel: isKm ? 'AI OCR ស្រង់តារាងទៅ .docx & .xlsx' : 'AI OCR to .docx & .xlsx',
      icon: FileImage,
